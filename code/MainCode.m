...
%% SELECT VIDEO
global VIDEO % Global variable for the interface
quiver1=findobj('Type','axes','Tag','axes7'); % Location of axes in the interface
% VIDEO='Videos/VIDEO0185.mp4';   % Video path  Uncoment if you are not using the interface
...
h = msgbox('Click Ok and then any button of your keyboard!','Success');
pause;
% clear
